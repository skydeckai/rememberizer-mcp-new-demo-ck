...
This is the new demo CK

Please note that `rememberizer-mcp-new-demo-ck` is currently in development and the functionality may be subject to change.
...
If you have SkyDeck AI Helper app installed, you can search for "Rememberizer" and install the rememberizer-mcp-new-demo-ck.
...
"mcpServers": {
  "rememberizer": {
      "command": "uvx",
      "args": ["rememberizer-mcp-new-demo-ck"]
    },
}
```
